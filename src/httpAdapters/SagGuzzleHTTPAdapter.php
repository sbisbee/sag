<?php
/**
 * Uses the GuzzlePHP library (which in turn uses cURL) for HTTP communication
 * with CouchDB. This gives you more advanced features, like SSL supports, with
 * the cost of an additional dependency that your shared hosting environment
 * might now have. 
 *
 * @version 0.8.0
 * @package HTTP
...
class SagCURLHTTPAdapter extends SagHTTPAdapter {
  ...
  public function __construct($host, $port) {
    ...
    $this->client = new \Guzzle\HTTP\Client($host . ':' . $port);
  }
